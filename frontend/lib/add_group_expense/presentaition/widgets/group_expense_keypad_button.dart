...
class GroupExpenseKeypadButton extends StatefulWidget {
  final String text;
  final bool isPrimary;
  final bool isAction;
  final VoidCallback onTap;

  const GroupExpenseKeypadButton({
    super.key,
    required this.text,
    required this.onTap,
  ...
  @override
  State<GroupExpenseKeypadButton> createState() =>
      _GroupExpenseKeypadButtonState();
}

class _GroupExpenseKeypadButtonState extends State<GroupExpenseKeypadButton> {
  bool _pressed = false;
